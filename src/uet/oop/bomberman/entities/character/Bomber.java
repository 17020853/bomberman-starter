...
public class Bomber extends Character {
    ...
    private void detectPlaceBomb() {
        ...
        if(_input.space && _timeBetweenPutBombs<1 && Game.getBombRate()>0  ) {
            _timeBetweenPutBombs = Game.TIME_BETWEEN_BOOM;
            Game.addBombRate(-1);
            placeBomb(Coordinates.pixelToTile(_x), Coordinates.pixelToTile(_y-Game.TILES_SIZE/2));
        }
    }
